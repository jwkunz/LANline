...
Debug Tone), nearest-station finders, seek, REST session with heartbeat, live
radio/telemetry display, and received-audio playback over WebRTC/Opus (Play
button — a user gesture is required to start audio).
